...
class HomeController: UIViewController {
    ...
    @IBOutlet weak var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.register(UINib(nibName: Constants.Nib.HomeCell, bundle: .main), forCellWithReuseIdentifier: HomeCell.identifier)
            collectionView.register(UINib(nibName: Constants.Nib.HomeHeaderView, bundle: .main), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: HomeHeaderView.identifier)
        }
    }
...
extension HomeController: HomePresenterView {
    ...
    func configureToRefresh() {
        refreshControl.animatedImage = GIFAnimatedImage(data: try! Data(contentsOf: Bundle.main.url(forResource: "pizza-loop", withExtension: "gif")!))
    ...
    func displayMessageView(icon: Icon, text: String, sizeIcon: Int, backgroundColor: UIColor) {
        view.displayMessageView(icon: .notFound, text: text, sizeIcon: sizeIcon, backgroundColor: backgroundColor, isButton: true, titleButton: "RELOAD") { [weak self] in
