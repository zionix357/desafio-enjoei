...
class DetailController: UIViewController {
    ...
    @IBOutlet weak var collectionView: UICollectionView! {
        didSet {
            ...
            collectionView.register(UINib(nibName: Constants.Nib.PhotoPageCell, bundle: .main), forCellWithReuseIdentifier: PhotoPageCell.identifier)
        }
    }
...
extension DetailController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: PhotoPageCell.identifier, for: indexPath) as! PhotoPageCell
...
extension DetailController: DetailPresenterView {
    ...
    func display(strike: String, boldOne: String, boldTwo: String, color: UIColor) {
        priceLabel.addStrikethrough(stringStrike: strike, stringBoldOne: boldOne, stringBoldTwo: boldTwo, colorStrike: color)
    }
