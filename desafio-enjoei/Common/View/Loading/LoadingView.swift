...
extension UIView {
    ...
    @objc func displayLoadingIndicator(side:CGFloat = 128, text:String? = nil, backgroundColor:UIColor = .white) {
        guard !isDisplayingLoadingIndicator else { return }
        
        let loadingOverlay = LoadingViewOverlay(spinnerSide: side, text: text)
